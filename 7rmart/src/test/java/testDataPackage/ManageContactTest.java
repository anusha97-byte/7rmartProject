...
{  
	...
	public void verify_UserIs_AbleTo_UpdateTheContact() throws IOException
	{
		...
		managecontactpage.clickUpdateIcon().enterPhoneNumber(phone).enterEmailId(email).enterAddress(address1).enterDeliveryTime(dtime).enterChargeLimit(climit).clickUpdateButton();
